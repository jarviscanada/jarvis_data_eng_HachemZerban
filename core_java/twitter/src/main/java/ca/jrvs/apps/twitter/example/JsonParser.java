...
public class JsonParser {
   ...
   */
  public static String toJson(Object object, boolean prettyJson, boolean inculdeNullValues)
      throws JsonProcessingException {
    ObjectMapper m = new ObjectMapper() ;
    if (!inculdeNullValues){
  ...
  public static void main(String[] args) {
    ...
    System.out.println(toJson(company,true,flase));
