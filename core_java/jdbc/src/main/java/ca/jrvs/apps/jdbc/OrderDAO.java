...
public class OrderDAO extends DataAccessObject<Order> {
  private final String GET_ONE="SELECT c.first_name, c.last_name, c.email, o.order_id, o.creation_date, o.total_due, o.status, s.first_name, s.last_name, s.email, ol.quantity, p.code, p.name, p.size, p.variety, p.price from "
      + "orders o join customer c on o.customer_id = c.customer_id "
